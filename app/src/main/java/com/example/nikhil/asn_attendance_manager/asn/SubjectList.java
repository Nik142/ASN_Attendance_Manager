...
public class SubjectList extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Toast toast = Toast.makeText(this, "Hint : Consider lectures and practicals of same subject as different subjects.", Toast.LENGTH_LONG);
		toast.show();
	}
	...
	public void onClick(View v) {
		...
		if(v.getId()==R.id.button1){ // Save and Add
			...
			Toast toast = Toast.makeText(SubjectList.this, num+" subject(s) added.", Toast.LENGTH_SHORT);
